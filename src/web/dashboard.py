...
.stat {{ background: #161b22; border: 1px solid #30363d; border-radius: 8px; padding: 24px; min-width: 180px; }}
.stat h3 {{ color: #8b949e; font-size: 14px; text-transform: uppercase; margin-bottom: 8px; }}
...
<div class="stats">
    <div class="stat"><h3>Today</h3><div class="value">{stats['today']}</div></div>
    <div class="stat"><h3>This Week</h3><div class="value">{stats['week']}</div></div>
    <div class="stat"><h3>All Time</h3><div class="value">{stats['total']}</div></div>
    <div class="stat"><h3>Status</h3><div class="value"><span class="badge badge-ok">Running</span></div></div>
</div>
<div class="section">
    <h2>Capabilities</h2>
    <table>
        ...
        <tr><td>PR Code Review</td><td><span class="badge badge-active">Active</span></td><td>pull_request.opened webhook</td></tr>
        ...
        <tr><td>DingTalk Notifications</td><td><span class="badge badge-active">Active</span></td><td>On events</td></tr>
    </table>
</div>
<div class="section">
    <h2>Configuration</h2>
    <table>
        ...
        <tr><td>Target Repo</td><td>MemTensor/MemOS</td></tr>
        <tr><td>LLM Light</td><td>claude-haiku-4.5-thinking</td></tr>
        <tr><td>LLM Heavy</td><td>claude-opus-4.6-thinking</td></tr>
        <tr><td>Module Labels</td><td>plugin, memos</td></tr>
    </table>
</div>
</body></html>"""
